...
The `overflow` style in android is `hidden` and cannot be changed. This is the resultVo of Android View framework. This only happens on Android, iOS will work as expected.
